...
function theme_scripts() {
	...
	// Ajax variable
	// global $wp_query;
	// wp_localize_script('main', 'MyAjax', array('url' => admin_url('admin-ajax.php'), 'query' => $wp_query->query));
}
 ...
 * Ajax method
 */
add_action('wp_ajax_nopriv_ajax_method', 'ajax_method');
add_action('wp_ajax_ajax_method', 'ajax_method');
